...
NYCdistricts <- readOGR(base_url, 'OGRGeoJSON', verbose = T)
...
# join tabular data
ggNYCdistricts<-left_join(ggNYCdistricts, latest_impact_puma_acs, by=c("id"="puma10"))
...
ggplot(ggNYCdistricts, aes(x=long, y=lat)) +
    ...
    theme_bw() +
    labs(title = "Recovery since spring 2020 (difference in COVID impact between now and then)",
