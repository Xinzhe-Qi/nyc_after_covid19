...
We draw demographic information from the Census Bureau's latest 2019 American Community Survey (one-year estimates) corresponding to NYC's neighborhoods delineated by Community Districts. Three demographic variables we consider are
...
We examine the relationship between these variables and the impact of the pandemic on license applications for new businesses. The chart below shows scatterplots with lines representing best fits estimated with simple least square estimators.
