...
Moreover, contact information which is not needed in this analysis was removed for privacy as well as to keep the data size small.
...
levels(ny_license$borough) <- c("Bronx", "Brooklyn", "Manhattan", "Queens", "Stetan_Island")
